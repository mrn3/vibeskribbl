...
exports.default = GameSummaryCard;
// Game summary card component showing recent games
const react_1 = __importDefault(require("react"));
function GameSummaryCard({ games, maxGames = 5 }) {
    ...
    return (<div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        {recentGames.map((game, index) => (<div key={game.gameId} className="px-6 py-4 hover:bg-gray-50">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-shrink-0 text-right">
                <div className="flex items-center space-x-2">
                  {game.winner && (<div className="text-right">
            ...
            <div className="mt-3 flex flex-wrap gap-1">
              {game.rounds.slice(0, 3).map((round, roundIndex) => (<div key={roundIndex} className="inline-flex items-center px-2 py-1 rounded-md text-xs bg-gray-100 text-gray-700" title={`Round ${round.roundNumber}: ${round.word} (${round.playersWhoGuessed}/${round.totalPlayers - 1} guessed)`}>
              ...
              {game.rounds.length > 3 && (<div className="inline-flex items-center px-2 py-1 rounded-md text-xs bg-gray-100 text-gray-500">
      ...
      {games.length > maxGames && (<div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
