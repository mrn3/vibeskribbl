...
export default function WordSelector({ words, onSelect, timeLeft = 10 }: WordSelectorProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full">
        ...
        <div className="grid gap-4">
          {words.map((word) => (
            <button
              key={word}
              className="py-3 px-6 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-lg text-lg transition-colors"
